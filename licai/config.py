...
def load_settings(config_path: str | Path | None = None, dry_run_override: bool | None = None) -> Settings:
    ...
    return Settings(
        ...
        quote_refresh_seconds=int(raw.get("quote_refresh_seconds", 2)),
        ...
        hedge_max_wait_seconds=float(raw.get("hedge_max_wait_seconds", 2.0)),
        hedge_second_leg_chases=int(raw.get("hedge_second_leg_chases", 2)),
